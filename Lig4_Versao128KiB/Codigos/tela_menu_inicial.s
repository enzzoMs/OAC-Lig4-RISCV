...
RENDERIZAR_ESCOLHA_COR:		
	...
	# Imprimindo a tela de seleção de cor no frame 0
		la a0, matriz_tiles_menu_inicial_cor_pecas	# carregando a imagem da matriz de tiles
		...
		la a4, tiles_menu_inicial			# carregando a imagem dos tiles
...
RENDERIZAR_ESCOLHA_DIFICULDADE:		
	...
	# Imprimindo a tela de seleção de dificuldade no frame 0
		la a0, matriz_tiles_menu_inicial_dificuldade	# carregando a imagem da matriz de tiles
		addi a0, a0, 8					# pula para onde começa os pixels .data
		li a1, 0xFF000000				# seleciona como argumento o frame 0
		li a2, 16					# numero de colunas de tiles a serem impressos
		li a3, 12					# numero de linhas de tiles a serem impressos		
